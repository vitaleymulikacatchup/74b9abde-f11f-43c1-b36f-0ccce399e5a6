...
export const metadata: Metadata = {
  title: "Grand Azure Hotel - Luxury Accommodations & Five-Star Service",
  description: "Experience unparalleled luxury at Grand Azure Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, five-star accommodations, premium rooms, spa, fine dining, business hotel, city hotel",
  openGraph: {
    title: "Grand Azure Hotel - Luxury Accommodations & Five-Star Service",
    description: "Experience unparalleled luxury at Grand Azure Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
    ...
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/34428372/pexels-photo-34428372.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Grand Azure Hotel exterior showcasing modern luxury architecture"
    }]
  },
  twitter: {
    ...
    title: "Grand Azure Hotel - Luxury Accommodations & Five-Star Service",
    description: "Experience unparalleled luxury at Grand Azure Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service in the heart of the city.",
    images: ["https://images.pexels.com/photos/34428372/pexels-photo-34428372.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
